<template>
    <svg version="1.1" viewBox="0 0 300 94" xmlns="http://www.w3.org/2000/svg">
        <defs>
        ...
        <g fill="url(#logoFill)">
            ...
            <path d="m62 20-14 48h13l8-27 8 27h13l-14-48z" />
...
<style lang="less">
    ...
    #logoTopBorder, #logoTopText {
        fill: @gold;
        transform-origin: 0px 0px;
    }
    #logoBottomBorder, #logoBottomText {
        fill: @dark-gold;
