    ...
    <div class="userInOnlineList" :class="{currentUser: isCurrentUser, disconnected: isDisconnected}">
        ...
        <div class="userWrapper">
            <div class="userSection">
                ...
                <div class="userMenu">
                    <message-to-user-link :nickname="user.name" :messageType="privatMessageType" title="Личное сообщение">ЛС</message-to-user-link>
                </div>
...
import statusIcon from './ChatUserStatus.vue';
    ...
    div.userInOnlineList {
        ...
        &:hover {
            .userWrapper .userSection {
                background-color: mix(@blue, rgba(0,0,0,0), 40%);
            }
