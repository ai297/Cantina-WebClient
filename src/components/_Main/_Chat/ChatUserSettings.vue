...
import {GENDER, FONTS, COLORS, VALIDATION_PATTERNS, API_URL, MESSAGE_TYPES, CHAT_COMMANDS} from '../../../constants.js';
...
export default {
    ...
    methods: {
        ...
        saveSettings: function() {
            ...
            // сохранение профиля
            this.$http.patch(API_URL.USERINFO, this.userProfile)
            .then((response) => {
                // если успешно
    ...
    created: function() {
        ...
        this.$http.get(API_URL.USERINFO).then(result => {
